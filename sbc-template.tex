...
cadeia, e todos os outros assinantes alcançaveis na rede peer-to-peer
...
Além diss, introduz um sistema de reputação distribuído para lidar com abuso
...
A Figura~\ref{fig.table} descreve os três tipos de cadeia oferecidos pelo \FC:
identidade pública, grupos privados e fóruns públicos.

\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth]{table.png}
\caption{Os 3 tipos de cadeias do \FC}
\label{fig.table}
\end{figure}
...
apresentado a seguir para serem viáveis sob completa descentralização.
%
