...
\item Combater SPAM, notícias falsas e conteúdo ilegal demandando reputação
...
Cada cadeia possui um conjunto de \emph{blocos} com as postagens ou mensagens,
destacadas como elipses coloridas (roxo, vermelho e verde), em cada cor
...
10EEB7...
$ freechains chain "#chat" traverse all 10EEB7... # todos ate o genesis
A563EF... 12AB5C... FA2144...
...
Inicialmente, usamos o hash do bloco gênesis como âncora, já que nenhum bloco
ainda foi lido.
...
A563EF...                           # 1o bloco recebido
12AB5C...                           # 2o bloco recebido
FA2144...                           # 3o bloco recebido
\end{verbatim}
}
%
...
No \FC, cada cadeia é controlada por um sistema de reputação autônomo que
contabiliza a quantidade de likes e dislikes a autores e postagens.
Como cada cadeia é independente, a reputação de um autor pode variar entre
elas.
A unidade de reputação é conhecida como \emph{rep} e pode ser gerada, consumida
e transferida de diversas formas:
%
\begin{itemize}
\item Geração:
    \begin{itemize}
